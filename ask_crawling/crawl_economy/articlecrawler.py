...
class ArticleCrawler(object):
    ...
    def crawling(self, category_name):
        ...
        # text_company, text_headline, content_url
        df = pd.DataFrame(columns=['title', 'press'])
        ...
        for url in target_urls:
            ...
            for content_url in post_urls:  # 기사 url
                ...
                try:
                    ...
                    df = df.append(pd.DataFrame([text_headline, text_company]))
        ...
        s_year = self.date['start_year']
        s_month = self.date['start_month']
        s_day = self.date['start_day']
